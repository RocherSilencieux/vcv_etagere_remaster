...
- Restored cable deletion event to Left-Click, while keeping decorative port loops non-hit-testable so dragging from ports remains fully functional and non-blocking.
